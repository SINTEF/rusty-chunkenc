...
func (p *pool) Get(e Encoding, b []byte) (Chunk, error) {
	...
	case EncHistogram:
		return nil, fmt.Errorf("histogram chunk not supported")
	case EncFloatHistogram:
		return nil, fmt.Errorf("float histogram chunk not supported")
	default:
...
func (p *pool) Put(c Chunk) error {
	...
	case EncXOR:
		...
		sp = &p.xor
	case EncHistogram:
		return fmt.Errorf("histogram chunk not supported")
	case EncFloatHistogram:
		return fmt.Errorf("float histogram chunk not supported")
	default:
